function createScatterPlotPopulation() {
...
// Adds the svg canvas
var svg = d3.select("#population-scatter-plot")
    .append("svg")
...
fetch('data/all_years_data.json')
    ...
    .then(data => {
        ...
        data.forEach(function(d) {
            d.Population = parseFloat(d['Population']); // Fix the space in the key
        ...
        svg.selectAll("dot")
            ...
            .on("mouseover", function(event, d) {
                ...
                tooltip.html(d.Country + "<br/>" + d.Year + "<br/>Life Expectancy: " +
                        d.LifeExpectancy + "<br/>Population: " + d.Population)
        ...
        svg.append("g")
            ...
            .call(xAxis.tickFormat(function(d) { return d / 1000000 + "M"; }));
